...
//hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh//
	...
	let isRepelled = false; // Tracks the toggle state

function onMouseClick() {
    isRepelled = !isRepelled; // Toggle state

    particles.forEach(p => {
        if (isRepelled) {
            // Move particles far from their destination
            p.vx = (Math.random() - 0.5) * 200; 
            p.vy = (Math.random() - 0.5) * 200;
        } else {
            // Reset their velocity so they move back to text
            p.vx = 0;
            p.vy = 0;
        }
    });
